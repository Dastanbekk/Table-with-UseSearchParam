...
const Archived = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/posts?_page=${page}&_limit=${100}`)
  ...
  return (
    <div>
      <div className="px-4 bg-white mt-5 py-5 h-[72vh] overflow-y-scroll ">
        <h3 className="font-bold text-xl">Archived Products</h3>
              ...
              if (value.status == "archived") {
                return (
                  ...
                  >
                    ...
                    <th className="">
                      <p className="bg-red-500 text-white inline py-1 px-2 rounded-md">
                        {value.status}
                      </p>
                    </th>
