  ...
  return (
    <div>
      <div className="px-4 bg-white mt-5 py-5 h-[72vh] overflow-y-scroll ">
        <h3 className="font-bold text-xl">Active Products</h3>
          ...
          <tbody className="w-full ">
            {data.map((value) => {
                ...
                if(value.status === "active"){
                   return  <tr key={value.id} className="w-full  border-b border-gray-300">
                    ...
                    <th ><p className="bg-green-500 text-white inline py-1 px-2 rounded-md">{value.status}</p> </th>
